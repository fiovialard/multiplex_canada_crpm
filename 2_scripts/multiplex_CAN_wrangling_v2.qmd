...
Wrangling and combination of 3 datasets:

1\) AideSmart app results ($n=$ 401)

2\) test results from RECAP ($n=$ 164)

3\) test results from REZO ($n=$ 237)
...
12 new infections given previous known negative or unknown status
...
### find positives and create column with positive vs negative results for each pathogen as factor
...
summary(rezo.infection7$new.hiv) #2
...
one extra recap participant that was not captured in the app or removed
